...
Open pull requests also get a live preview of their changes at
`https://yykamei.github.io/yk-elements/pr-<PR number>/catalog/`, published
automatically and linked from a bot comment on the pull request. Previews are
removed once the pull request is closed.
