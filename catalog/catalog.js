...
/**
 * Attribute metadata for the checkbox, which mirrors only value, default
 * state, and validation attributes — checkboxes have no placeholder, length,
...
const checkboxFieldAttributes = [
  {
    ...
    default: 'on',
    description:
      'Value submitted to the form while the checkbox is checked, mirrored onto the internal input.',
  },
  {
    name: 'checked',
    control: 'boolean',
...
const checkboxFaceProperties = [
  ...
  {
    name: '--yk-input-checkbox-cursor',
    default: 'pointer',
    description: 'Mouse cursor over the check box.',
  },
  {
  ...
  {
    name: '--yk-input-checkbox-checked-image',
    default: 'Bootstrap checkmark SVG',
    description:
      'Background image of the checked face. The SVG data URI cannot interpolate a CSS variable, so the whole image is the overridable unit.',
  },
  {
    name: '--yk-input-checkbox-indeterminate-image',
    default: 'Bootstrap dash SVG',
    description: 'Background image of the indeterminate face.',
  },
  {
  ...
  },
  {
    ...
    description: 'Filter applied while the check box is pressed.',
  },
  {
    name: '--yk-input-checkbox-disabled-opacity',
    default: '0.5',
    description:
      'Opacity of the input face and the slotted label while disabled.',
  },
  {
